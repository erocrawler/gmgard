...
export class GachaIndexComponent implements OnInit {
    ...
    get supportAnimation() {
        return this.gachaService.supportAnimation();
    }
                    ...
                    this.gachaService.gacha(this.pool.poolName, count)
                        .switchMap(r => {
                            ...
                            const obs = r.items.map(i => {
                                ...
                                img.src = "//static.gmgard.com/Images/gacha/" + i.name + ".png";
                                return o;
                            });
                            return forkJoin(...obs)
                        })
    ...
    get supportVideoPhone() {
        return !this.isTouchDevice() || "playsInline" in document.createElement("video");
    }
