...
export class GachaService {
    ...
    private loadVideo(): Observable<number> {
        ...
        return this.makeRequest(["//static.gmgard.com/Images/gacha/gacha.mp4"], handleData);
    }
    ...
    cardUrl(name: string): SafeStyle {
        return this.sanitizer.bypassSecurityTrustStyle(`url(//static.gmgard.com/Images/gacha/${name}.png)`);
    }
