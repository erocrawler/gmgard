				...
				elements: [
					...
					children: [
						...
						children: [
							...
							type: 'select',
							id: 'txtBorder',
							requiredContent: 'table[class,border]',
							// Avoid setting border which will then disappear.
							'default': editor.filter.check( 'table[class,border]' ) ? 'true' : 'false',
							...
							setup: function (selectedTable) {
								this.setValue( selectedTable.getAttribute('class').indexOf('table-bordered') != -1 ? 'true' : 'false' );
							},
							commit: function (data, selectedTable) {
							    ...
							    selectedTable.setAttribute('class', c);
							}
						},
							{
							id: 'cmbAlign',
