...
namespace AspNet.Identity.EntityFramework6
{
    ...
    public class IdentityDbContext<TUser> : IdentityDbContext<TUser, IdentityRole, int, IdentityUserLogin, IdentityUserRole, IdentityUserClaim, IdentityUserToken, IdentityRoleClaim>
    ...
    public class IdentityDbContext<TUser, TRole, TKey, TUserLogin, TUserRole, TUserClaim, TUserToken, TRoleClaim> : DbContext
        where TUser : IdentityUser
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            var tokens = modelBuilder.Entity<TUserToken>()
