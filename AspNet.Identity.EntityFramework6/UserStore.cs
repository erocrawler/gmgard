...
namespace AspNetCore.Identity.EntityFramework6
{
    ...
    public class UserStore<TContext> : UserStore<IdentityUser<int, IdentityUserLogin, IdentityUserRole, IdentityUserClaim, IdentityUserToken>, TContext>
    ...
    public class UserStore<TUser, TContext> : UserStore<TUser, IdentityRole, TContext>
        where TUser : IdentityUser<int, IdentityUserLogin, IdentityUserRole, IdentityUserClaim, IdentityUserToken>, new()
        where TContext : DbContext
    {
        public UserStore(TContext context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    /// <typeparam name="TContext">The type of the data context class used to access the store.</typeparam>
    public class UserStore<TUser, TRole, TContext> : UserStore<TUser, TRole, IdentityUserRole, IdentityUserClaim, IdentityUserLogin, IdentityUserToken, IdentityRoleClaim, TContext, int>
        where TUser : IdentityUser<int, IdentityUserLogin, IdentityUserRole, IdentityUserClaim, IdentityUserToken>, new()
        where TRole : IdentityRole<int, IdentityUserRole, IdentityRoleClaim>, new()
        where TContext : DbContext
    {
        public UserStore(TContext context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    ...
    public class UserStore<TUser, TRole, TContext, TKey> : UserStore<TUser, TRole, IdentityUserRole<TKey>, IdentityUserClaim<TKey>, IdentityUserLogin<TKey>, IdentityUserToken<TKey>, IdentityRoleClaim<TKey>, TContext, TKey>
    ...
    public class UserStore<TUser, TRole, TUserRole, TUserClaim, TUserLogin, TUserToken, TRoleClaim, TContext, TKey> :
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private Task AddUserTokenAsync(TUserToken token)
        {
            UserTokens.Add(token);
            return Task.CompletedTask;
        }

        private Task<TUserToken> FindTokenAsync(TUser user, string loginProvider, string name, CancellationToken cancellationToken)
        {
            return UserTokens.FindAsync(cancellationToken, new object[] { user.Id, loginProvider, name });
        }
        ...
        private Task RemoveUserTokenAsync(TUserToken token)
        {
